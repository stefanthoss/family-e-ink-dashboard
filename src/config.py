...
class DashboardConfig:
    def __init__(self) -> None:
        ...
        self.SHOW_ADDITIONAL_WEATHER: bool = bool(
            os.getenv("SHOW_ADDITIONAL_WEATHER", "False")
        )
        self.SHOW_MOON_PHASE: bool = bool(os.getenv("SHOW_MOON_PHASE", "False"))
        self.SHOW_CALENDAR_NAME: bool = bool(os.getenv("SHOW_CALENDAR_NAME", "False"))
